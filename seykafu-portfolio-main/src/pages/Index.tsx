          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div className="order-2 md:order-1">
              ...
              <div className="mt-8 flex space-x-4 animate-on-load">
                ...
                <Link to="/career-support" className="px-6 py-3 border border-portfolio-accent text-portfolio-accent rounded hover:bg-portfolio-accent hover:text-white transition-colors">
                  Career Support
                </Link>
              </div>
            </div>
