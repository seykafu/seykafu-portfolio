      ...
      <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-4">
        ...
        <div className="liquid-glass rounded-2xl p-5">
          ...
          <p className="text-sm leading-relaxed text-portfolio-text/80">
            ...
            <a href="https://ravage.game" target="_blank" rel="noopener noreferrer" className="text-portfolio-accent hover:underline">Ravage</a> the tactical RPG via my studio{' '}
            <a href="https://pencatgames.com" target="_blank" rel="noopener noreferrer" className="text-portfolio-accent hover:underline">Pencat Games</a>,{' '}
